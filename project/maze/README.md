...
## Known GTK Mem Leak 
Arbitrarily there will be a mem leak of 453,055 bytes or another amount due to GTK cleanup. We just want to point out that this is not due to our code.



### But actually not_core_dumped_in_a_maze <3
